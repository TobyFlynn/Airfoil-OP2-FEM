...
void op_par_loop_flux_zero(char const *, op_set,
  op_arg );
...
int main(int argc, char **argv) {
  ...
  op_par_loop_flux_zero("flux_zero",cells,
  ...
  for(int i = 0; i < iter; i++) {
    for(int j = 0; j < 3; j++) {
      ...
      op_par_loop_get_neighbour_q("get_neighbour_q",edges,
                  ...
                  op_arg_dat(nx,0,edge2cells,15,"double",OP_READ),
                  op_arg_dat(ny,0,edge2cells,15,"double",OP_READ),
                  op_arg_dat(nx,1,edge2cells,15,"double",OP_READ),
                  op_arg_dat(ny,1,edge2cells,15,"double",OP_READ),
                  op_arg_dat(fscale,0,edge2cells,15,"double",OP_READ),
                  op_arg_dat(fscale,1,edge2cells,15,"double",OP_READ),
                  op_arg_dat(workingQ,0,edge2cells,60,"double",OP_READ),
                  op_arg_dat(workingQ,1,edge2cells,60,"double",OP_READ),
                  op_arg_dat(flux,0,edge2cells,60,"double",OP_INC),
                  op_arg_dat(flux,1,edge2cells,60,"double",OP_INC));
      ...
      op_par_loop_get_bedge_q("get_bedge_q",bedges,
                  ...
                  op_arg_dat(fscale,0,bedge2cells,15,"double",OP_READ),
                  op_arg_dat(workingQ,0,bedge2cells,60,"double",OP_READ),
                  op_arg_dat(flux,0,bedge2cells,60,"double",OP_RW));
      op_timers(&cpu_loop_2, &wall_loop_2);
      ...
      op_par_loop_euler_rhs("euler_rhs",cells,
                  ...
                  op_arg_dat(flux,-1,OP_ID,60,"double",OP_RW),
